...
class _mainScreenState extends State<mainScreen> {
  ...
  List<String> navBarItems = [
    "Top news" ,"india","udaipur","ctae","vegetables","potlitics",
    "hindustan","bharat","fruits",
  ];
bool isLoading = true;
  getNewsByQuery() async{
    Response response= await get(Uri.parse("https://newsapi.org/v2/everything?q=world&from=2023-05-04&sortBy=publishedAt&apiKey=fa5b68512b554d3e944fc2d475bd9c55"));
